...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "empmanagement/test/integration/FirstJourney",
    "empmanagement/test/integration/EmployeesListJourney",
    "empmanagement/test/integration/EmployeesObjectPageJourney",
    "empmanagement/test/integration/LeaveRequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
